...
<form action = "movie_insert.php" method = "post">
    ...
    <input type="number" name="duration" placeholder="Vnesi dolžino filma v minutah" class="form-control" /><br/>
    <input type="number" name="year_release" placeholder="Vnesi datum izdaje" class="form-control" /><br/>
