...
$id = (int)$_POST['id'];//kateri film urejamo
$title  = $_POST['title'];
...
if((!empty($title))){
    ...
    //vse žanre, kateremu film pripada, najprej izbrišemo
    ...
    //preusmeritev na seznam vshe filmov
    header("Location: movies.php"); die();
}
//preusmeritev nazaj na update - nekaj je narobe
